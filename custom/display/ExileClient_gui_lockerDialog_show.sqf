...
_lockerAmount = _lockerAmount call Exile_util_addCommas; 
_lockerLimit = _lockerLimit call Exile_util_addCommas;
...
_inventoryAmount = _inventoryAmount call Exile_util_addCommas;
