...
// Custom Loadout Starts Here. Uncomment the lines you want your players to have..
	...
	//_bambiPlayer addBackpack "B_TacticalPack_oli"; // Change Backpack Class Here
	...
	_bambiPlayer addItemToVest "Chemlight_blue"; // Ammo For Weapon Listed Below
	_bambiPlayer addItemToVest "30Rnd_556x45_Stanag"; // Ammo For Weapon Listed Below
	_bambiPlayer addItemToVest "30Rnd_556x45_Stanag"; // Ammo For Weapon Listed Below

	// Weapons
	_bambiPlayer addWeapon "Exile_Weapon_M4"; // Weapon
